...
%
Using the prior shape knowledge that the lung shape is approximately convex along the ribcage, we observed that taking the convex hull of the initial mask gives a shape that includes large tumors. However, the convex hull over segments the lung in non convex regions such as the mediastinum and diaphragm. 

The concept of using alpha shapes to represent a point set was originally presented in ~\cite{edelsbrunner1983}. A convex hull is a generalization of an alpha shape, with all convex hulls being alpha shapes but not all alpha shapes are convex hulls. By adjusting a single parameter $\alpha$ a family of shapes associated with a finite set of points can be obtained.
...
\begin{figure}[t]
  \centering
  \begin{tabular}{ccc}
    \includegraphics[width=1.5in]{figs/alpha200} & 
    \includegraphics[width=1.5in]{figs/alpha25} & \includegraphics[width=1.5in]{figs/alpha9} \\
  \end{tabular}
...
\begin{figure}[t]
  \centering
  \begin{tabular}{ccc}
    \includegraphics[width=1.5in]{figs/step_pass} & 
    \includegraphics[width=1.5in]{figs/step_alpha} & \includegraphics[width=1.5in]{figs/step_osf} \\
  \end{tabular}
