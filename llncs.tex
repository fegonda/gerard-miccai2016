...
%
\todo[author=SG,inline]{Add brief description of OSF}
...
\todo[author=SG,inline]{Maybe show result at each step for each subject and remove other figure that shows each step for one subject}
\begin{figure}[t]
  \centering
    \subfigure[PFS-031]{
    \includegraphics[width=2in]{figs/result1}
    \label{fig:result1}
    }
    \subfigure[PFS-032]{
    \includegraphics[width=2in]{figs/result2}
    \label{fig:result2}
    }
    \subfigure[PFS-011]{
    \includegraphics[width=2in]{figs/result3}
    \label{fig:result3}
    }
    \subfigure[PFS-020]{
    \includegraphics[width=2in]{figs/result4}
    \label{fig:result4}
    }
  \caption{Result for four subjects. Red fill indicates our result, blue contour represents manual segmentation.}
  \label{fig:resultseg}
\end{figure}
