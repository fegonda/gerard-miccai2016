...
Normal lungs have high contrast with the surrounding anatomoy, making lung segmentation relatively trivial using thresholding based methods(citations here). However, in the presence of large tumors, conventional threshold based methods fail since tumors are not included.
...
\end{figure}
\todo[author=SG,inline]{Remove all this old crap}
...
\todo[author=SG,inline]{Replace with bibtex file}
%
% ---- Bibliography ----
%
