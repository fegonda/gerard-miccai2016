...
Normal lung tissue has high contrast with the surrounding anatomy, making lung segmentation relatively robust using simple thresholding based methods~\cite{guo2008,hu2001}. However, in the presence of large tumors, conventional threshold based methods fail due to the radiodense tumors are excluded from the segmentation. An accurate lung tissue segmentation is required during radiation therapy planning, e.g., to predict the dose delivered to the normal lung tissue and the tumor. 
